...
class BeerControllerTest {
    ...
    BeerDto validBeer;
    BeerPagedList validBeerPagedList;
    ...
    void setUp() {
        ...
        validBeerPagedList = new BeerPagedList(List.of(validBeer));
    }
    ...
    void listBeers() {
        ...
        webTestClient.get()
                ...
                .value(beerDtos -> beerDtos.stream().findFirst().get().getId(), equalTo(validBeer.getId()));
    }
